/**
 * Per-listing page copy: the short note under the heading and the long-form
 ...
 * other.
 *
 * STRUCTURE follows the Furniture Lovers storefront (furniture-lover.vercel.app),
 * whose collection pages break the long note into several headed sections
 * followed by a "Common questions" accordion, rather than one wall of prose.
 * The paragraphs below are unchanged from the single-heading version; they have
 * been grouped and given headings, not rewritten.
 *
 ...
 * warranties, returns, finance, payment, stock, provenance or manufacturing,
 * because none of those are confirmed by the client. The one business fact used
 * is that the showroom is in Sheffield, which is established by the site's own
 * copy.
 *
 ...
 * category. The acceptance suite asserts that every product named here is
 * rendered on that page, that none belongs to another category, and that the
 * text matches none of 21 unconfirmed-claim patterns.
 */
...
export type ListingCopy = {
  ...
  intro: string;
  /** The long note below the grid, in headed sections. */
...
const SEEING = "Seeing them in person";

export const categoryCopy: Record<string, ListingCopy> = {
  /* ── Sofas ─────────────────────────────────────────────────── */
  sofas: {
    h1: "Sofas",
    intro:
    ...
    sections: [
      ...
      {
        heading: "How many seats you need",
        paragraphs: [
    ...
    faqs: [
      ...
      { q: "Can I see these sofas before I buy?", a: SHOWROOM_SOFT },
    ],
  },
  ...
  "corner-sofas": {
    ...
    sections: [
      ...
      {
        heading: "Which way the corner runs",
        paragraphs: [
      ...
      {
        heading: "Fabrics and seat support",
        paragraphs: [
      ...
      {
        heading: SEEING,
        paragraphs: [`A corner sofa is a large commitment to make from a photograph. ${SHOWROOM_SOFT}`],
      },
    ],
    faqs: [
      {
      ...
      { q: "Can I see these corner sofas before I buy?", a: SHOWROOM_SOFT },
    ],
  },
  ...
  "recliner-sofas": {
    ...
    sections: [
      ...
      {
        heading: "Clearance, height and size",
        paragraphs: [
      ...
      {
        heading: "Upholstery and mechanisms",
        paragraphs: [
  ...
  beds: {
    ...
    sections: [
      {
        heading: "Measuring for a bed frame",
        paragraphs: [
      ...
      {
        heading: "Fabrics and what is included",
        paragraphs: [
  ...
  dining: {
    ...
    sections: [
      {
        heading: "How many people eat here",
        paragraphs: [
      ...
      {
        heading: "Tops, bases and seating",
        paragraphs: [
      ...
      {
        heading: "Room to pull a chair out",
        paragraphs: [
      ...
      {
        heading: SEEING,
        paragraphs: [`Chair comfort is the part that photographs least well. ${SHOWROOM_SOFT}`],
      },
    ],
    faqs: [
      {
  ...
  chairs: {
    ...
    sections: [
      {
        heading: "Scale and where they fit",
        paragraphs: [
  ...
  "coffee-tables": {
    ...
    sections: [
      {
        heading: "Height against your sofa",
        paragraphs: [
      ...
      {
        heading: "Shape and the nesting option",
        paragraphs: [
  ...
  wardrobes: {
    ...
    sections: [
      {
        heading: "Height and getting it into the room",
        paragraphs: [
      ...
      {
        heading: "Hinged or sliding doors",
        paragraphs: [
      ...
      {
        heading: "Mirror fronts and depth",
        paragraphs: [
  ...
  decor: {
    ...
    sections: [
      {
        heading: "Getting the rug size right",
        paragraphs: [
      ...
      {
        heading: "Lamp height and layered light",
        paragraphs: [
      ...
      {
        heading: SEEING,
        paragraphs: [`Colour and texture are the hardest things to judge on a screen. ${SHOWROOM_SOFT}`],
      },
    ],
    faqs: [
      { q: "What size is the rug?", a: "The Heaton Wool Blend Rug is 160cm by 230cm, in a wool-blend pile." },
      {
      ...
      { q: "Can you help me put a scheme together?", a: SHOWROOM_SOFT },
    ],
  },
};

/**
 * /shop is the single listing root: every category is reachable from it and
 * every breadcrumb on the site starts there. /collection used to render the
 * identical page at a second URL and now redirects here permanently.
 */
export const shopCopy: ListingCopy = {
  h1: "Shop Furniture",
  intro:
    "Every range in one place: sofas, corner and recliner sofas, beds, dining sets, chairs, coffee tables, wardrobes and decor. Filter by category or room, or search by name.",
  sections: [
    {
      heading: "Where to start",
      paragraphs: [
        "There are two sensible ways in. If you are furnishing one room, filter by room and work across the categories together, so the sofa, the coffee table and the rug are chosen against each other rather than one at a time. If you are replacing a single piece, filter by category and sort by price to see the range end to end.",
        "Every card shows the price and the range name, and the product page behind it carries the dimensions, the materials and the configuration in full.",
      ],
    },
    {
      heading: "Sizes are on every product page",
      paragraphs: [
        "Width, depth and height are listed for every piece, and for corner sofas and extendable tables both measurements are given separately so each can be checked against a different wall. The largest piece on the site is 298cm wide and the smallest is a 45cm cushion, so measuring first saves the most time.",
      ],
    },
    {
      heading: "Browsing by category",
      paragraphs: [
        "Each category page carries a longer note on choosing within that range — what the sizes mean in a real room, which materials are used, and the questions we are asked most often about those pieces. If you already know what you are looking for, go straight there from the links below.",
      ],
    },
    {
      heading: SEEING,
      paragraphs: [
        `Photographs are the hardest way to judge fabric, finish and scale. ${SHOWROOM_SOFT}`,
      ],
    },
  ],
  faqs: [
    {
      q: "How do I find something for a particular room?",
      a: "Use the room filter to narrow the grid to Living Room, Bedroom, Dining Room or Home Office, then use the category filter within that to look at one type of piece at a time.",
    },
    {
      q: "Where do I find the dimensions?",
      a: "Every product page lists width, depth and height under Dimensions, along with the materials and the configuration. The category pages summarise the size range across each set of products.",
    },
    {
      q: "Can I sort by price?",
      a: "Yes. The sort control offers price low to high, price high to low, and name A to Z, as well as the default featured order.",
    },
    { q: "Can I see these in person?", a: SHOWROOM_SOFT },
  ],
};

export const categoryCopyFor = (slug: string): ListingCopy | undefined => categoryCopy[slug];
